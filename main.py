...
print("Sentiments MNB best score is ", gridb.best_score_)
print("Sentiments MNB best hyper parameter is ", gridb.best_params_)
#---------------------------------------------------------------
...
# Sentiments:
print("------Sentiments Decision Tree analysis (hyper parameters)--------")
